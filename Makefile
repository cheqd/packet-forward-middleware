...
ifeq ($(LEDGER_ENABLED),true)
  ifeq ($(OS),Windows_NT)
    ...
    ifeq ($(UNAME_S),OpenBSD)
      $(warning OpenBSD detected, disabling ledger support (https://github.com/cheqd/cosmos-sdk/issues/1988))
    else
...
ldflags = -X github.com/cheqd/cosmos-sdk/version.Name=sim \
		  -X github.com/cheqd/cosmos-sdk/version.AppName=simd \
		  -X github.com/cheqd/cosmos-sdk/version.Version=$(VERSION) \
		  -X github.com/cheqd/cosmos-sdk/version.Commit=$(COMMIT) \
		  -X "github.com/cheqd/cosmos-sdk/version.BuildTags=$(build_tags_comma_sep)"

# DB backend selection
ifeq (cleveldb,$(findstring cleveldb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/cheqd/cosmos-sdk/types.DBBackend=cleveldb
endif
ifeq (badgerdb,$(findstring badgerdb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/cheqd/cosmos-sdk/types.DBBackend=badgerdb
endif
# handle rocksdb
ifeq (rocksdb,$(findstring rocksdb,$(COSMOS_BUILD_OPTIONS)))
  CGO_ENABLED=1
  BUILD_TAGS += rocksdb
  ldflags += -X github.com/cheqd/cosmos-sdk/types.DBBackend=rocksdb
endif
# handle boltdb
ifeq (boltdb,$(findstring boltdb,$(COSMOS_BUILD_OPTIONS)))
  BUILD_TAGS += boltdb
  ldflags += -X github.com/cheqd/cosmos-sdk/types.DBBackend=boltdb
endif
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/cheqd/cosmos-sdk/types"
	godoc -http=:6060
...
format:
	...
	find . -name '*.go' -type f -not -path "./vendor*" -not -path "*.git*" -not -path "./client/docs/statik/statik.go" -not -path "./tests/mocks/*" -not -name '*.pb.go' | xargs goimports -w -local github.com/cheqd/cosmos-sdk
.PHONY: format
...
devdoc-init:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/cheqd/cosmos-sdk" -w "/go/src/github.com/cheqd/cosmos-sdk" tendermint/devdoc echo
	# TODO make this safer
	$(call DEVDOC_SAVE)

devdoc:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/cheqd/cosmos-sdk" -w "/go/src/github.com/cheqd/cosmos-sdk" devdoc:local bash
